...
module.exports = async(zaki, msg, m, setting, store, welcome, left, set_welcome_db, set_left_db, db_respon_list, opengc, set_proses, set_done, set_open, set_close) => {
    try {
...
break
	...
	case 'bot': case prefix+'bot':
		replyt(`*Bot Aktif Kak, Ketik #Menu Jika Perlu Bantuan*`)
			break
			
	case prefix+'sewa':
replyt(`*➛ JASA BOT STORE BY JO OFFICIAL 🏷️*
_❏ Jadibot : 20k/Bulan_
_❏ Sewa Bot : 10K/Bulan_

➛ *Fitur Bot 👁️‍🗨️*
_⊳ Add, delete, update list_
_⊳ Kalkulator_
_⊳ Hidetag (mention all member)_
_⊳ Validasi id Game_
_⊳ Proses & Done Orderan_
_⊳ Set, change, delete Proses & Done_
_⊳ Set ppgc, namegc, descgc_
_⊳ Open & Close GC_
_⊳ Add & Kick Member_
...
_⊳ Anti Delay_
_⊳ Hemat Kuota_
_⊳ Bisa Req NamaBot, Owner, PP Menu_
